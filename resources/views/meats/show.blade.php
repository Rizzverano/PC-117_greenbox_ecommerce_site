            ...
            <div class="col-12 col-lg-10 col-xl-8">
                <div class="card shadow-sm" style="border-radius: 15px; overflow: hidden; border: none;">
                    <div class="card-header py-3" style="background-color: #28a745; color: white;">
                        <h2 class="h4 mb-0">{{ $meat->name ?? 'Meat Details' }}</h2>
                    </div>
                    ...
                    <div class="card-body">
                        @if ($meat)
                            <div class="row g-4">
                                ...
                                <div class="col-md-5 col-lg-4">
                                    <div class="text-center p-3" style="background-color: #f8f9fa; border-radius: 10px;">
                                        ...
                                        <div class="mt-3">
                                            <h4 class="text-success m-0">₱{{ number_format($meat->price, 2) }}</h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-7 col-lg-8">
                                    <div class="mb-4">
                                        <h4 class="text-muted mb-3">{{ $meat->intro }}</h4>
                                        <p class="lead mb-0" style="line-height: 1.6;">{{ $meat->description }}</p>
                                    </div>
                            ...
                            <div class="d-flex flex-wrap gap-3 mt-4">
                                ...
                                <a href="{{ route('meats.index') }}" class="btn btn-outline-success px-4 py-2 flex-grow-1" style="min-width: 120px;">
                                    <i class="fas fa-arrow-left me-2"></i>Go Back
                                </a>
                                @endif
                            </div>
