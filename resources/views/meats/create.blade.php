            ...
            <div class="col-12 col-lg-8 col-xl-6">
                <div class="card shadow-sm" style="border-radius: 15px; border: none;">
                    <div class="card-header py-3" style="background-color: #28a745; color: white;">
                        <h4 class="mb-0">Create New Meat</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('meats.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="d-flex flex-wrap gap-3 mt-4">
                                ...
                                <a href="{{ route('meats.index') }}" class="btn btn-outline-success px-4 py-2 flex-grow-1" style="min-width: 120px; border-radius: 8px;">
