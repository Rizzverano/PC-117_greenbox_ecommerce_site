                ...
                <div class="card shadow-sm" style="border-radius: 15px; overflow: hidden;">
                    <div class="card-header py-3" style="background-color: #28a745; color: white;">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('vegefruits.create') }}" class="btn btn-light btn-sm" title="Add New Vegefruit"
                                style="color: #28a745;">
                                            ...
                                            <td>
                                                <div class="d-flex flex-column gap-2">
                                                    <div class="d-flex gap-1">
                                                        <a href="{{ route('vegefruits.show', $item->id) }}"
                                                            title="View Vegefruit"
                                                            class="btn btn-info btn-sm py-1 flex-grow-1">
                                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                                        </a>
                                                        <a href="{{ route('vegefruits.edit', $item->id) }}"
                                                            title="Edit Vegefruit"
                                                            class="btn btn-primary btn-sm py-1 flex-grow-1">
                                                            <i class="fa fa-pencil-alt" aria-hidden="true"></i>
                                                        </a>
                                                    </div>
                                                    <form method="POST"
                                                        action="{{ route('vegefruits.destroy', $item->id) }}"
