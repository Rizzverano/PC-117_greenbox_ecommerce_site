                    ...
                    <div class="card-body">
                        <form action="{{ route('seafoods.update', $seafood->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    @for($i = 1; $i <= 5; $i++)
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="{{ $ingred }}" id="{{ $ingred }}"
                                                value="{{ $seafood->$ingred }}" class="form-control" style="border-radius: 8px;">
                                        </div>
                                    @endfor
                            ...
                            <div class="d-flex flex-wrap gap-3 mt-4">
                                ...
                                <a href="{{ route('seafoods.index') }}" class="btn btn-outline-success px-4 py-2 flex-grow-1" style="min-width: 120px; border-radius: 8px;">
