            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                        <h2>My Seafood Dish</h2>
                    </div>
                    <div class="card-body">
                        <a href="{{ route('seafoods.create') }}" class="btn btn-success btn-sm" title="Add New Seafood">
                                ...
                                <tbody>
                                    @foreach ($seafoods as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('seafoods.show', $item->id) }}" title="View Seafood">
                                                    <button class="btn btn-info btn-sm">
                                                        <i class="fa fa-eye" aria-hidden="true"></i> View
                                                    </button>
                                                </a>

                                                <a href="{{ route('seafoods.edit', $item->id) }}" title="Edit Seafood">
                                                    <button class="btn btn-primary btn-sm">
                                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit
                                                    </button>
                                                </a>

                                                <form method="POST" action="{{ route('seafoods.destroy', $item->id) }}"
