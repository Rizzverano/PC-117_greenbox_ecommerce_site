...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h2>{{ $seafood->name ?? 'Seafood Details' }}</h2>
        </div>
        <div class="card-body">
            @if ($seafood)
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <div class="mt-3 text-center">
                            <h4 class="text-success">${{ number_format($seafood->price, 2) }}</h4>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="mb-4">
                            <h4 class="text-muted">{{ $seafood->intro }}</h4>
                            <p class="lead">{{ $seafood->description }}</p>
                        </div>
